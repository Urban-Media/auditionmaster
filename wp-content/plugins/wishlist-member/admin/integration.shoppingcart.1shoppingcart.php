 ...
 * Version: $Id: integration.shoppingcart.1shoppingcart.php 3179 2017-01-31 13:42:11Z mike $
 */
		...
		<?php include_once($this->pluginDir . '/admin/integration.shoppingcart-payperpost-skus.php'); ?>
			...
			<form method="post">
				<table class="form-table">
					...
					<tr>
						<th scope="row"><?php _e('API Notification URL', 'wishlist-member'); ?></th>
						<td>
							<p><a href="<?php echo $scthankyou_url ?>" onclick="return false"><?php echo $scthankyou_url ?></a>
								<?php echo $this->Tooltip("integration-shoppingcart-1shoppingcart-tooltips-notificationurl"); ?>

							</p>
							<p><?php _e('Add this URL as a "Notification URL" in 1ShoppingCart under My Account &gt; API &gt; API Settings', 'wishlist-member'); ?></p>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<label>
								<input type="radio" name="<?php $this->Option('onesc_include_upsells'); ?>" value="1"<?php $this->OptionChecked(1); ?> />
								<?php _e('Yes', 'wishlist-member'); ?>
							</label>
							&nbsp;
							<label>
								<input type="radio" name="<?php $this->Option(); ?>" value="0"<?php $this->OptionChecked(0); ?> />
								<?php _e('No', 'wishlist-member'); ?>
							</label>
						</td>
					</tr>
					<tr>
