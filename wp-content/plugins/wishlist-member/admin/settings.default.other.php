<form method="post">
	<table class="form-table">
		...
		<tr valign="top">
			<th scope="row" style="border:none;white-space:nowrap"><?php _e('Auto Login Member After Clicking Confirmation Link:', 'wishlist-member'); ?></th>
			<td style="border:none">
				<label><input type="radio" name="<?php $this->Option('auto_login_after_confirm'); ?>" value="1"<?php $this->OptionChecked(1); ?> />
					<?php _e('Yes', 'wishlist-member'); ?></label>
				&nbsp;
				<label><input type="radio" name="<?php $this->Option(); ?>" value="0"<?php $this->OptionChecked(0); ?> />
					<?php _e('No', 'wishlist-member'); ?></label> <?php echo $this->Tooltip("settings-default-tooltips-auto-login-after-confimation-click"); ?>
			</td>
		</tr>
		<tr valign="top">
			<td colspan="2" style="border:none">
