...
<form method="post">
	...
	<br />
	<h3><?php _e('HTML Tags Support', 'wishlist-member'); ?></h3>
	<table class="form-table">
		<th scope="row" style="border:none"><?php _e('Support HTML Tags on the Email Templates:', 'wishlist-member'); ?></th>
		<td style="border:none">
			<label><input type="radio" name="<?php $this->Option('html_tags_support'); ?>" value="1"<?php $this->OptionChecked(1); ?> />
				<?php _e('Yes', 'wishlist-member'); ?></label>
			&nbsp;
			<label><input type="radio" name="<?php $this->Option(); ?>" value="0"<?php $this->OptionChecked(0); ?> />
				<?php _e('No', 'wishlist-member'); ?></label>
	...
	<h3 style="margin-bottom:0"><?php _e('Email Confirmation Reminder', 'wishlist-member'); ?> <?php echo $this->Tooltip("settings-email-tooltips-Registration-Email-Confirmation-Reminder"); ?></h3>
	<table class="form-table">
		<tr valign="top">
			<th scope="row" style="border:none" ><?php _e('Send First Reminder After:', 'wishlist-member'); ?>
			</th>
			<td style="border:none"><input type="text" name="<?php $this->Option('email_conf_send_after', false); ?>" value="<?php $this->OptionValue(); ?>" size="3" /> Hour(s) <?php echo $this->Tooltip("settings-email-tooltips-email-confirmation-first-reminder"); ?></td>
		</tr>
		<tr valign="top">
			<th scope="row" style="border:none" ><?php _e('How Many Reminders To Send:', 'wishlist-member'); ?></th>
			<td style="border:none"><input type="text" name="<?php $this->Option('email_conf_how_many', false); ?>" value="<?php $this->OptionValue(); ?>" size="3" /></td>
		</tr>
		<tr valign="top">
			<th scope="row" style="border:none" ><?php _e('Send Reminders Every:', 'wishlist-member'); ?></th>
			<td style="border:none"><input type="text" name="<?php $this->Option('email_conf_send_every', false); ?>" value="<?php $this->OptionValue(); ?>" size="3" /> Hour(s)</td>
		</tr>
	</table>
	<br />
