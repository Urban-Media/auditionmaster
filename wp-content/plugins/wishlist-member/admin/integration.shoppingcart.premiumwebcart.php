<?php
/*
 * CloudNet360 Shopping Cart Integration
 * Original Author : Glen Barnhardt
 * Version: $Id: integration.shoppingcart.premiumwebcart.php 3201 2017-02-22 14:09:47Z mike $
 */

$__index__ = 'premimwebcart';
$__sc_options__[$__index__] = 'CloudNet360 (formerly Premium Web Cart)';
...
if (wlm_arrval($_GET,'cart') == $__index__) {
	if (!$__INTERFACE__) {
		...
		<!-- CloudNet360 -->
		<blockquote>
			<h2 class="wlm-integration-steps">Step 1. Configure CloudNet360 Settings:</h2>
			<form method="post">
				...
				<h2 class="wlm-integration-steps"><?php _e('Step 2. Use the URL below as the Post/Callback URL in CloudNet360:', 'wishlist-member'); ?></h2>
				<p><?php _e('The Post/Callback URL is used in the CloudNet360 integraton and thank you pages.', 'wishlist-member'); ?></p>
