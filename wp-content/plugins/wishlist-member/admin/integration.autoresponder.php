 ...
 * Version: $Id: integration.autoresponder.php 3179 2017-01-31 13:42:11Z mike $
 */
...
if (wlm_arrval($_POST,'saveAR') == 'saveAR' && $_POST['ar']) {
	if ( isset( $_POST['migrate_mcar'] ) ) { //mailchimp migrate to v3 backup old settings
		$this->SaveOption('Autoresponders_mcbackup', $data);
	}
	...
	<table class="form-table">
		<tr>
			...
			<?php if (!empty($__ar_videotutorial__[$data['ARProvider']])): ?>
					<p class="alignright" style="margin-top:0"><a href="<?php echo ($wlm_ar_vidlink = $__ar_videotutorial__[$data['ARProvider']]); ?>" target="_blank"><?php _e('Watch Integration Video Tutorial', 'wishlist-member'); ?></a></p>
			<?php endif; ?>
			</td>
		</tr>
		<tr valign="top">
