...
<form id="membership-levels-frm" method="post">
								...
								<table width="100%" class="MembershipLevelsAdvanced">
									<tr>
										...
										<td style="width:215px;">
											...
											<br  />
											<label><input type="checkbox" name="wpm_levels[<?php echo $wpm_newid ?>][registrationdatereset]" value="1" /> <?php _e( 'Registration Date Reset [Expired Level]', 'wishlist-member' ); ?></label>
											<?php echo $this->Tooltip( "membershiplevels-default-tooltips-registrationdatereset" ); ?>
											<br  />
											<label><input type="checkbox" name="wpm_levels[<?php echo $wpm_newid ?>][registrationdateresetactive]" value="1" /> <?php _e( 'Registration Date Reset [Active Level]', 'wishlist-member' ); ?></label>
											<?php echo $this->Tooltip( "membershiplevels-default-tooltips-registrationdateresetactive" ); ?>
											<br  />
	...
	<p class="submit">
		...
		<input type="submit" id="btn_add_new_level" class="button button-primary" value="<?php _e( 'Add New Level', 'wishlist-member' ); ?>" />
	</p>
</form>
<script> 
