		...
		if($status) {
			...
			switch ($status) {
                                case 'active':
                                        ...
                                        $search_sql[] = " ( $wpdb->users.ID NOT IN  (".implode(',', $cancelledMemberIDs).") ) ";
                                        $search_sql[] = " ( $wpdb->users.ID NOT IN  (".implode(',', $unConfirmedMemberIDs).") ) ";
                                        $search_sql[] = " ( $wpdb->users.ID NOT IN  (".implode(',', $approvalMemberIDs).") ) ";
                                        $search_sql[] = " ( $wpdb->users.ID NOT IN  (".implode(',', $expiredmembersIDs).") ) ";
